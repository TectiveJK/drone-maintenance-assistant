...
class MainWindow(QMainWindow):
 ...
 def build_style(self):
  self.setStyleSheet("QMainWindow,QWidget#root,QStackedWidget{background:#b8bcc1;} QListWidget{background:#252b31;color:white;border:0;padding:12px;} QListWidget::item{padding:15px 10px;border-radius:6px;margin:2px;} QListWidget::item:selected{background:#46515b;} QLabel#title{font-size:29px;font-weight:700;color:#000000;} QLabel#subtitle{color:#000000;} QGroupBox{background:#d9dcdf;border:1px solid #aeb4b9;border-radius:9px;padding:10px;} QPushButton{background:#e5e7e9;border:1px solid #92999f;padding:9px 16px;border-radius:6px;} QPushButton:hover{background:#f0f1f2;} QTableWidget{background:#e1e3e5;border:1px solid #9da4aa;gridline-color:#c3c7ca;} QHeaderView::section{background:#cbd0d4;padding:8px;font-weight:600;color:#000000;} QLineEdit,QTextEdit,QComboBox{background:#eef0f1;border:1px solid #9da4aa;padding:6px;color:#000000;}")
